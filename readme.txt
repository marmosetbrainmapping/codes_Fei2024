Software:
MATLAB R2019b/R2020a
Python 3.8

Instructions on codes:
1. In /structure-connectivity-analysis-for-two-datasets/ directory, it contains analysis codes associated with allen-population tracing data and single-neuron data.
...
2. In /wide-field-data-Figure5andFigure6/ directory,  it contains analysis codes associated with wide field data.
    The codes are provided for generating the figure 5, figure6, figure S7 , figure S8and figure S9. And the nomenclature of each code comprehensively specifies its purpose and its intended image analysis context.

3. In /computational modelling/ directory, it contains the codes for quantifying heterogeneity from single-neuron projectome data (results for Fig.2) and all the model simulations (results for Fig.3&4).