...
% variation_range: homotopic FC variation range under different levels of noises and heterogeneity.
...
%     tic
    ...
    for i = 1:length(Nregion_range)
        ...
        overlap_heteros = ones(Nregion,Nregion)*overlaphetero1;
        ...
        overlap_heteros = ones(Nregion,Nregion)*overlaphetero2;
        overlap_heteros(logical(eye(Nregion))) = nan;
        W = RandomNetwork_Bilateral(N,Nregion,miuE,sE,nE,miuI,sI,ntargets,nsources,nself,ncontras,overlap_heteros,overlap_homos);
        Ws{i,2} = W;
    end
...
toc
%%
save('/zfs/scratch/qihang/HeteroVariationRange.mat');
%%
