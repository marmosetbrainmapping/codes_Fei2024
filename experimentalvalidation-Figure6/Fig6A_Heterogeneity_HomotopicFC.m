...
load('/zfs/scratch/qihang/SingleCellProjection/ccfv3bilateralFC.mat');
load('/zfs/scratch/qihang/SingleCellProjection/ccfv3cortexregionnames.mat');
...
figure
hold on
x = heterogeneity_downstream(inds);
y = regionscorr;
...
r = R(1,2);
p = P(1,2);
title(['r=',num2str(round(r*1000)/1000),',p=',num2str(round(p*1000)/1000)]);
xlabel('Hhomo');
ylabel("homotopic FC");
